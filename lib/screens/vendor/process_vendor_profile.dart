...
class ProcessVendorScreen extends StatefulWidget {
  const ProcessVendorScreen({Key? key}) : super(key: key);

  @override
  State<ProcessVendorScreen> createState() => _ProcessVendorScreenState();
}

class _ProcessVendorScreenState extends State<ProcessVendorScreen> {
