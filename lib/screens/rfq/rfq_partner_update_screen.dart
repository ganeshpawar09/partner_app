...
class _RfqPartnerDetailState extends State<RfqPartnerDetailScreen> {
  ...
  void onAdd() {
    ...
    if (val1.isNotEmpty && val2.isNotEmpty) {
      Provider.of<RfqPartnerPriceState>(context, listen: false)
          .updaterfqpartner(id, int.parse(val1));
    }
  }
  ...
  Widget build(BuildContext context) {
    final dynamic id = ModalRoute.of(context)!.settings.arguments;
    final rfq = Provider.of<RfqPartnerPriceState>(context).singlerfqitem(id);
    return Scaffold(
